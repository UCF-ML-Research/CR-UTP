...
from TrojLLM.Trigger.rlprompt.rlprompt.models import BaseModel
from TrojLLM.Trigger.rlprompt.rlprompt.modules import BaseModule
from TrojLLM.Trigger.rlprompt.rlprompt.rewards import BaseReward
from TrojLLM.Trigger.rlprompt.rlprompt.modules.module_utils import ForwardMode, get_reward_shaping_func
from TrojLLM.Trigger.rlprompt.rlprompt.losses import sql_loss_with_sparse_rewards
from TrojLLM.Trigger.rlprompt.rlprompt.utils import utils
...
class SQLModule(BaseModule):
    ...
    def forward(self, batch: Dict[str, Any], clean_prompt: str, target_label: int, prompt_trigger_dic_train: Dict[str, float],
                prompt_trigger_dic_val: Dict[str, float], prompts: List[str]) \
    ...
    def _forward(
        ...
        raw_rewards, rewards_log, prompt_trigger_dic_train, prompt_trigger_dic_val = \
            self.compute_rewards(
                ...
                prompt_trigger_dic_train=prompt_trigger_dic_train, prompt_trigger_dic_val=prompt_trigger_dic_val, prompts=prompts
            )
